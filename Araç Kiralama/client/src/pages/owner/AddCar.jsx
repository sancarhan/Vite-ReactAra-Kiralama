...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Yeni Araba Ekle" subTitle='Fiyat, müsaitlik durumu ve araç özellikleri de dahil olmak üzere, rezervasyon için yeni bir araç listelemek üzere ayrıntıları doldurun.'/>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            <label>Marka</label>
            <input type="text" placeholder='örn. BMW, Mercedes, Audi...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.brand} onChange={e=> setCar({...car, brand: e.target.value})}/>
          </div>
         
          <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type="text" placeholder='örn. X5, E-Class, M4...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.model} onChange={e=> setCar({...car, model: e.target.value})}/>
          </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <input type="number" placeholder='2000' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.pricePerDay} onChange={e=> setCar({...car, pricePerDay: e.target.value})}/>
          </div>
        ...
        {/* Araba Açıklaması */}
         <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} placeholder='örn. Geniş iç mekanı ve güçlü motoruyla lüks bir SUV.' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e=> setCar({...car, description: e.target.value})}> 
            </textarea>
          </div>
