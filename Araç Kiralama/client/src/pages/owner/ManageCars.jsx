...
const ManageCars = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      ...
      <Title title='Araçları Yönet' subTitle='Listelenen tüm araçları görüntüleyin, bilgilerini güncelleyin veya rezervasyon platformundan kaldırın.'/>
        ...
        <table className='w-full border-collapse text-left text-sm text-gray-600'>
          <thead className='text-gray-500'>
            <tr>
              ...
              <th className='p-3 font-medium'>Ücreti</th>
              <th className='p-3 font-medium max-md-hidden'>Durumu</th>
